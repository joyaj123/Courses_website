...
def create_app():
    ...
    # COURSES API
    app.add_url_rule("/api/courses", view_func=api_get_all_courses, methods=["GET"])
    ...
    # COURSE DETAILS
    app.add_url_rule(
        "/courses/<int:course_id>/details",
        view_func=course_details,
        methods=["GET"]
    )
    ...
    # ENROLLMENT API
    app.add_url_rule(
        "/api/courses/<int:course_id>/enroll",
        view_func=enroll_course,
        methods=["POST"]
    )

    app.add_url_rule(
        "/api/courses/<int:course_id>/enrollment-status",
        view_func=check_enrollment,
        methods=["GET"]
    )

    app.add_url_rule(
        "/api/my-courses",
        view_func=my_courses,
        methods=["GET"]
    )
